...
CREATE TABLE IF NOT EXISTS "outgoing_messages" (
	...
	"broadcast_id" bigint NOT NULL,
	"segment_id" bigint NOT NULL,
	CONSTRAINT "outgoing_messages_broadcast_id_segment_id_message_run_at_re_key" UNIQUE("recipient_phone_number","message","run_at","broadcast_id","segment_id")
);
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "outgoing_messages" ADD CONSTRAINT "outgoing_messages_broadcast_id_broadcasts_id_fk" FOREIGN KEY ("broadcast_id") REFERENCES "broadcasts"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
